...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { kind: @discount.kind, name: @discount.name, price: @discount.price, product_ids: @discount.product_ids } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { kind: @discount.kind, name: @discount.name, price: @discount.price, product_ids: @discount.product_ids } }
